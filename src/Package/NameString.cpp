...
// Static storage for NameString interning
...
void NameString::GetIndex(const std::string& value)
{
    ...
    static const int stricmptable[256] = {
    ...
    for (size_t i = 0; i < compareValue.size(); i++)
